...
#  downloadFilePath = here::here("test_files", "out.tif")
#  print(filePath)
#  pathId = EDPackage::path.file.add(filePath, demo_token)[['id']]
#  Sys.sleep(10)
#  EDPackage::path.file.download(pathId = pathId, filePath =  downloadFilePath)
...
# Sys.sleep(10)
# EDPackage::path.raster.timestamp.file.download(pathId = mapId, timestampId = timestampId, fileId = uploadId, filePath = downloadFilePath, token = token)
# #
...
mapId <- "085f5e10-63b6-4e8f-a4c6-dce9689100d3"
timestampId <- "3179fa80-60ad-41c7-ae67-cdd5eeeca693"
#
#
...
# #
# # ##from here
# pendingDownloads = EDPackage::path.raster.timestamp.order.get(token)
...
Sys.sleep(10)
fileOut <- here::here("test_files", "out.zip") # paste0(filePath, "/out.zip")#'C:/Users/spamb/Downloads/out.zip'
EDPackage::path.vector.timestamp.file.download(pathId = mapId, timestampId = layerId, fileId = uploadId, filePath = fileOut, token = token)
#
