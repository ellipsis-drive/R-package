=======================================================================
Recovers a vector timestamp — path.vector.timestamp.recover • EDPackage
=======================================================================
...
.. rubric:: Recovers a vector timestamp
   :name: recovers-a-vector-timestamp

.. raw:: html

   <div class="hidden name">

``path.vector.timestamp.recover.Rd``
...
.. code:: r
   ...
   path.vector.timestamp.recover(pathId, timestampId, token)
