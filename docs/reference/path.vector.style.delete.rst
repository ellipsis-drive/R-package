==========================================================================
Delete the style for a given vector — path.vector.style.delete • EDPackage
==========================================================================
...
.. rubric:: Delete the style for a given vector
   :name: delete-the-style-for-a-given-vector

.. raw:: html

   <div class="hidden name">

``path.vector.style.delete.Rd``
...
.. code:: r
   ...
   path.vector.style.delete(pathId, styleId, token)
