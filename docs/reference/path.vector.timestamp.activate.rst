=================================================================
Activate a timestamp — path.vector.timestamp.activate • EDPackage
=================================================================
...
.. rubric:: Activate a timestamp
   :name: activate-a-timestamp

.. raw:: html

   <div class="hidden name">

``path.vector.timestamp.activate.Rd``
...
.. code:: r
   ...
   path.vector.timestamp.activate(pathId, timestampId, token)
