=====================================================================
Deactivate a timestamp — path.vector.timestamp.deactivate • EDPackage
=====================================================================
...
.. rubric:: Deactivate a timestamp
   :name: deactivate-a-timestamp

.. raw:: html

   <div class="hidden name">

``path.vector.timestamp.deactivate.Rd``
...
.. code:: r
   ...
   path.vector.timestamp.deactivate(pathId, timestampId, token)
